...
import { Calendar, Facebook, Instagram, MapPin, Twitter, Youtube } from "lucide-react"
      ...
      <div className={`w-full h-full bg-black/70 ${rounded} flex items-center justify-center p-4 sm:p-6`}>
        <div className="text-center max-w-2xl">
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-4 mt-6 sm:mt-10">
            <div className="bg-white rounded-full p-1.5 sm:p-2 w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center">
              <Facebook className="w-4 h-4 sm:w-5 sm:h-5 stroke-foreground" fill="black" strokeWidth={0} />
            </div>
            <div className="bg-white rounded-full p-1.5 sm:p-2 w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center">
              <Twitter className="w-4 h-4 sm:w-5 sm:h-5 stroke-foreground" fill="black" strokeWidth={0} />
            </div>
            <div className="bg-white rounded-full p-1.5 sm:p-2 w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center">
              <Instagram className="w-4 h-4 sm:w-5 sm:h-5 stroke-foreground" fill="black" />
            </div>
            <div className="bg-white rounded-full p-1.5 sm:p-2 w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center">
              <Youtube className="w-4 h-4 sm:w-5 sm:h-5 stroke-foreground" fill="black" />
            </div>
          </div>
        </div>
      </div>
